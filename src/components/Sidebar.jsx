...
/**
 * Sidebar — sticky left profile card for desktop (lg+).
 * Hidden on mobile — Navbar handles navigation there.
 */
export default function Sidebar() {
    ...
    return (
        ...
        >
            ...
            {/* Location */}
            <p className="t-small flex items-center justify-center gap-1 mb-4" style={{ color: "var(--text-subtle)", fontFamily: "monospace" }}>
            ...
            <div className="flex justify-center mb-5">
                ...
                >
                    {easterEgg
                        ? <><Zap size={9} className="inline-block mr-1" />chaos mode</>
                        ...
                        return (
                            <li key={id}>
                                <button
                                    ...
                                    className="w-full text-left flex items-center gap-3 px-3 py-2 rounded-lg transition-all duration-150 cursor-pointer text-sm"
                                    style={{
                                ...
                                >
                                    {isActive && (
                                        <motion.span
                                            ...
                                            className="absolute left-3 top-1/2 -translate-y-1/2 w-0.5 h-4 rounded-full"
                                    ...
                                    >
                                        {String(NAV_LINKS.indexOf({ label, id }) + 1).padStart(2, "0")}/
                                    </span>
                                    {label}
                                </button>
                            </li>
